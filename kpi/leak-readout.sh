#!/usr/bin/env bash
# ISI-3574 E0 — Deliverable #7: memory leak readout (TAIL-flat, NOT first-vs-last).
# ISI-1811 lesson: a mechanical first-vs-last rule TRIPS on normal warm-up floor-creep
...
# keeps rising, not a warm-up that plateaus. (ISI-3477: bounded creep on encode is
...
print("[leak] VERDICT:", "TAIL-FLAT (ok)" if drift<=5 else "TAIL-RISING — investigate over longer window (cf ISI-3477 boundedness)")
PY
