#!/usr/bin/env bash
# pod-census VALIDITY GATE (run FIRST, before any KPI).
# Note: assert PER-namespace, PER-pod — an aggregate check hides a
# dead entity. REFINED (09-03): validity depends on a pod's ROLE.
