...
#
# ⭐ LOCUST_RUN_TIME / --duration was NOT honoured on 1/8 pods in the prior
...
# ⭐ standard telemetrygen framing over the real Istio mesh (no slowloris).
set -euo pipefail
...
# Hard backstop : guarantee the window closes on time.
