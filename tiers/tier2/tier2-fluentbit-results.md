# Tier 2 (logs+metrics) — fluentbit — 24h soak readout
...
[load] locust pod=Running reqs=4228 | k6 pod=Running
[load] LOAD REACHING APP: PASS

## Dynatrace receipt gate (logs+metrics)
[dt-receipt] FB output proc_records=43371427 errors=0
...
## Loss accounting
[fluentbit] input=43440978 output=43440657 dropped=0 errors=0
