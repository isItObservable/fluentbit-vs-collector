# Tier 3 (logs+metrics+traces, NO tail sampling) — ARM 2 FB v5.1.1 — 24h soak readout
generated: 2026-09-15T01:16:13Z · engine=fluentbit-v5.1.1 · load=locust+k6+telemetrygen(traces@200 --otlp-http :4318)
topology: DaemonSet(logs) + StatefulSet(metrics) + Deployment(traces OTLP/HTTP 4318) — TIER-3 delta = traces pipeline

## Census gate
bench-fluentbit-logs-6mzv2 0 26h
bench-fluentbit-logs-7njbz 0 26h
bench-fluentbit-logs-tg2hn 0 26h
bench-fluentbit-metrics-0 0 26h
bench-fluentbit-traces-744898b4b5-q8vkn 0 26h
kepler-2xgll 0 12d
kepler-5jsm7 0 12d
kepler-c4ldd 0 12d
kepler-qhtc5 0 12d
...
hipster-shop       currencyservice-59bd4fd785-b9qk2   Running    1859      source 
hipster-shop       emailservice-6567d46c9d-s7rl2      Running    6         source 
hipster-shop       frontend-79cb8766c8-9lsdm          Running    8         source 
hipster-shop       paymentservice-75f5c95477-6mlq5    Running    27        source 
...
hipster-shop       redis-cart-6b7c8c4556-bfbpg        Running    1224      source 
...
[app-churn] log-source pods restarted DURING run (WARNING, non-fatal): 3
    hipster-shop/currencyservice-59bd4fd785-b9qk2 rc=1859 Error @2026-09-15T01:08:48Z
    hipster-shop/paymentservice-75f5c95477-6mlq5 rc=27 OOMKilled @2026-09-14T14:45:52Z
    hipster-shop/redis-cart-6b7c8c4556-bfbpg rc=1224 OOMKilled @2026-09-15T01:09:30Z

## DT receipt (FB output proc_records / dropped)
[dt-receipt] bench-fluentbit-logs-6mzv2 proc=21926049 dropped=0
[dt-receipt] bench-fluentbit-logs-7njbz proc=4965754 dropped=0
[dt-receipt] bench-fluentbit-logs-tg2hn proc=44089501 dropped=0
[dt-receipt] bench-fluentbit-metrics-0 proc=12496 dropped=0
[dt-receipt] bench-fluentbit-traces-744898b4b5-q8vkn proc=9369934 dropped=0
[dt-receipt] TOTAL proc_records=80363734 dropped=0 (logs+metrics+traces)
[dt-receipt] VERDICT: RECEIVED IN DYNATRACE (0 dropped)

## Memory leak check (tail-flat at 24h)
[leak] bench-fluentbit — 8 samples @ 15s
  2026-09-15T01:16:34Z  204MiB
  2026-09-15T01:16:49Z  200MiB
  2026-09-15T01:17:04Z  202MiB
  2026-09-15T01:17:19Z  213MiB
  2026-09-15T01:17:34Z  217MiB
  2026-09-15T01:17:49Z  203MiB
  2026-09-15T01:18:04Z  198MiB
  2026-09-15T01:18:19Z  190MiB

## Resource snapshot (working-set, per component)
bench-fluentbit-logs-6mzv2                21m   13Mi    
bench-fluentbit-logs-7njbz                15m   8Mi     
bench-fluentbit-logs-tg2hn                74m   20Mi    
bench-fluentbit-metrics-0                 2m    6Mi     
bench-fluentbit-traces-744898b4b5-q8vkn   38m   143Mi   

## Load note
[load] bench-load pods completed naturally at T+26h (~2026-09-15T01:14Z) — by design (telemetrygen 26h)
[load] Load ran for FULL soak window (T+2h gate through T+26h)
