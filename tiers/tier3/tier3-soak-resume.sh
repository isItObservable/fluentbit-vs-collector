#!/usr/bin/env bash
# ISI-3577 E3 — ARM 1 soak RESUME (driver died mid-sleep; gate passed 2026-09-12T23:02:54Z)
set -uo pipefail
...
T0="2026-09-12T21:00:47Z"  # original driver T0
...
echo "[soak-resume] RESUMED at $(date -u +%FT%TZ) — sleeping remaining ~58906s until soak end ~2026-09-13T23:03Z"
sleep 58906
...
echo "[soak-resume] tearing down bench-load (arm end)"; kubectl delete ns bench-load --wait=false 2>&1
echo "[soak-resume] Tier3 ARM1 DONE — FB arm is the next heartbeat's manual step"
