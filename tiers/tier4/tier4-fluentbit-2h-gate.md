# Tier 4 CONTROL ARM (FB v5.1.1 full stack, NO tail sampling) — 2h validity gate readout
generated: 2026-09-17T21:50:39Z · engine=fluentbit-v5.1.1 (single, collector offline) · load=locust+k6+telemetrygen(traces@200 --otlp-http :4318)
...
hipster-shop       currencyservice-59bd4fd785-b9qk2   Running    2372      source 
hipster-shop       emailservice-6567d46c9d-s7rl2      Running    9         source 
hipster-shop       frontend-79cb8766c8-9lsdm          Running    9         source 
hipster-shop       paymentservice-75f5c95477-6mlq5    Running    36        source 
...
hipster-shop       redis-cart-6b7c8c4556-bfbpg        Running    1537      source 
...
[load] locust(otel-demo) pod=Running reqs=440460 | k6(hipster-shop) pod=Running | tgen-traces pod=Running (@200 span/s --otlp-http)
[load] LOAD REACHING APP: PASS (app load + telemetrygen traces into FB OTLP input)

## Dynatrace receipt gate (pt9 — FB output proc_records / dropped)
[dt-receipt] bench-fluentbit-logs-cbm52 proc=2075473 dropped=0
[dt-receipt] bench-fluentbit-logs-q59f2 proc=1346067 dropped=0
[dt-receipt] bench-fluentbit-logs-wdqqq proc=452583 dropped=0
[dt-receipt] bench-fluentbit-metrics-0 proc=966 dropped=0
[dt-receipt] bench-fluentbit-traces-744898b4b5-98g9h proc=715197 dropped=0
[dt-receipt] TOTAL proc_records=4590286 dropped=0 (logs+metrics+traces)
...
[leak] bench-fluentbit — 12 samples @ 15s (needs metrics-server)
  2026-09-17T21:51:04Z  206MiB
  2026-09-17T21:51:19Z  199MiB
  2026-09-17T21:51:34Z  204MiB
  2026-09-17T21:51:49Z  201MiB
  2026-09-17T21:52:04Z  194MiB
  2026-09-17T21:52:19Z  202MiB
  2026-09-17T21:52:34Z  201MiB
  2026-09-17T21:52:49Z  202MiB
  2026-09-17T21:53:04Z  202MiB
  2026-09-17T21:53:19Z  178MiB
  2026-09-17T21:53:34Z  209MiB
  2026-09-17T21:53:49Z  187MiB
[leak] mid-third mean=199.8MiB  tail-third mean=194.0MiB  tail-drift=-2.88%
[leak] VERDICT: TAIL-FLAT (ok)

## Resource snapshot (working-set, per component)
bench-fluentbit-logs-cbm52                31m   13Mi    
bench-fluentbit-logs-q59f2                11m   12Mi    
bench-fluentbit-logs-wdqqq                16m   8Mi     
bench-fluentbit-metrics-0                 3m    7Mi     
bench-fluentbit-traces-744898b4b5-98g9h   35m   147Mi   
