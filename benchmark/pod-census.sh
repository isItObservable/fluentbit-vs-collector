#!/usr/bin/env bash
# B1-v2 — pod census capture (methodology rule D12).
#
...
# live on the benchmark cluster over 2026-07-20T11:00Z -> 2026-07-22T11:00Z: six pod
...
export KUBECONFIG="${3:-${KUBECONFIG:?set KUBECONFIG to the benchmark cluster}}"
...
EXPECTED_REPLICAS=1   # all three engines run replicas: 1 
