#!/usr/bin/env bash
# ============================================================================
# B1-v2 — PER-SIGNAL attribute-landing probe.
#
#   ./benchmark/attr-landing.sh <engine> [--window 15m]
#   ./benchmark/attr-landing.sh <engine> --from <utc> --to <utc>
#   ./benchmark/attr-landing.sh --selftest        # replay the R1P2 finding
#
...
#
# ---------------------------------------------------------------------------
# WHY THIS EXISTS (engine pre-flight, 2026-07-23)
# ---------------------------------------------------------------------------
...
# benchmark/service-key.dql), or the engine stops being the only variable.
#
# ---------------------------------------------------------------------------
...
# so count() on it is meaningless (dashboard caveat). The equivalent
